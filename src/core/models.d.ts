 ...
 * @returns 
 */
declare function originIds(ids: IdType[]): List;
...
declare class MetaModel extends Meta {
  static moduleToModels: Map2<any, any>;
...
declare class BaseModel extends Function {
  ...
  /**
   * slugGet() -> [id, seoName || displayName]

    Returns a textual representation for the records in ``this``.
    By default this is the value of the ``displayName`` field.

    @returns a pair ``[number, string]`` for this record
   */
  slug(): Promise<any[]>;
  ...
  /**
   * withContext([context][, **overrides]) -> records
    ...
    ``overrides`` are merged e.g.::
        ...
        r2 = records.withContext({}, key2=true)
