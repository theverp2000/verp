 ...
 * @param precisionRounding decimal number representing the minimum
        ...
        2-digit precision)
 */
export function floatIsZero(value, options: number | { precisionDigits?: number, precisionRounding?: number } = {}) {
...
function _floatCheckPrecision(options: { precisionDigits?: number, precisionRounding?: number } = {}) {
  ...
  if (precisionDigits != null) {
    // return 10 ** -precisionDigits; // Why 10**-4 => 0.00009999999999999999, fix right: 0.0001
