...
export function update(target: any, source: any, override: boolean = false) {
  return setOptions(target, source, true);
}

export function getEntries(obj: any): [string, any][] {
