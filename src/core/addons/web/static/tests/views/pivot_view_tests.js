...
function getCurrentValues(pivot) {
    return [...pivot.el.querySelectorAll(".o-pivot-cell-value div")]
        .map((el) => el.innerText)
        .join();
}
...
QUnit.module("Views", (hooks) => {
    ...
    QUnit.test("simple pivot rendering", async function (assert) {
        ...
        assert.hasClass(pivot.el.querySelector("table"), "o-enable-linking");
        assert.containsOnce(
            pivot,
            "td.o-pivot-cell-value:contains(32)",
    ...
    QUnit.test("pivot rendering with widget", async function (assert) {
        ...
        assert.containsOnce(
            pivot,
            "td.o-pivot-cell-value:contains(32:00)",
            "should contain a pivot cell with the sum of all records"
        );
    });
    ...
    QUnit.test("pivot rendering with string attribute on field", async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left button.dropdown-toggle"));
        assert.strictEqual(
            pivot.el.querySelector(".o-cp-bottom-left .dropdown-menu .dropdown-item").innerText,
            "BAR"
        );
        assert.strictEqual(
            pivot.el.querySelector(".o-pivot-measure-row").innerText,
            "BAR",
    ...
    QUnit.test("pivot rendering with invisible attribute on field", async function (assert) {
        ...
        assert.containsN(pivot, ".o-cp-bottom-left .dropdown-menu .dropdown-item", 2);
        // the invisible field souldn't be in the groupable fields neither
        await click(pivot.el.querySelector(".o-pivot-header-cell-closed"));
    ...
    QUnit.test("group headers should have a tooltip", async function (assert) {
        ...
        assert.strictEqual(
            pivot.el.querySelectorAll("tbody .o-pivot-header-cell-closed")[0].dataset.tooltip,
            "Date"
        );
        assert.strictEqual(
            pivot.el.querySelectorAll("thead .o-pivot-header-cell-closed")[1].dataset.tooltip,
            "Product"
        );
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.containsOnce(
                pivot,
                ".o-cp-bottom-left .dropdown-menu .dropdown-item:contains(Computed and not stored)"
            );
            assert.strictEqual(
                pivot.el.querySelector(".o-pivot-measure-row").innerText,
    ...
    QUnit.test("clicking on a cell triggers a doAction", async function (assert) {
        ...
        assert.hasClass(pivot.el.querySelector("table"), "o-enable-linking");
        await click(pivot.el.querySelectorAll(".o-pivot-cell-value")[1]); // should trigger a doAction
    });
    ...
    QUnit.test("row and column are highlighted when hovering a cell", async function (assert) {
        ...
        // hover third measure
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(3)", ["mouseover"]);
        ...
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(3)", ["mouseout"]);
    ...
    QUnit.test("columns are highlighted when hovering a measure", async function (assert) {
        ...
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(1)", ["mouseover"]);
        assert.containsN(pivot, ".o-cell-hover", 3);
        for (let i = 1; i <= 3; i++) {
            assert.hasClass(
        ...
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(1)", ["mouseout"]);
        assert.containsNone(pivot, ".o-cell-hover");

        // hover Count in second group
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(2)", ["mouseover"]);
        assert.containsN(pivot, ".o-cell-hover", 3);
        for (let i = 1; i <= 3; i++) {
            assert.hasClass(
        ...
        await triggerEvents(pivot.el, "th.o-pivot-measure-row:nth-of-type(2)", ["mouseout"]);
        assert.containsNone(pivot, ".o-cell-hover");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await triggerEvents(pivot.el, "th.o-pivot-origin-row:nth-of-type(5)", ["mouseover"]);
            assert.containsN(pivot, ".o-cell-hover", 3);
            for (let i = 1; i <= 3; i++) {
                assert.hasClass(
            ...
            await triggerEvents(pivot.el, "th.o-pivot-origin-row:nth-of-type(5)", ["mouseout"]);
            assert.containsNone(pivot, ".o-cell-hover");
        }
    );
    ...
    QUnit.test('pivot view with disable_linking="true"', async function (assert) {
        ...
        assert.doesNotHaveClass(pivot.el.querySelector("table"), "o-enable-linking");
        assert.containsOnce(pivot, ".o-pivot-cell-value");
        await click(pivot.el.querySelector(".o-pivot-cell-value")); // should not trigger a doAction
    });
    ...
    QUnit.test('clicking on the "Total" cell with time range activated', async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-pivot-cell-value"));
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            const pivot = await makeView({
                ...
                resModel: "partner",
                serverData,
                arch: `<pivot><field name="productId" type="row"/></pivot>`,
                searchViewArch: `
                    <search>
                        <filter name="date_filter" date="date" domain="[]" default_period='this_month'/>
                    </search>`,
            ...
            pivot.el.querySelectorAll(".o-pivot-cell-value")[1].click(); // should trigger a doAction with appropriate domain
            // here we click on the group corresponding to xphone/Total/This Month
            pivot.el.querySelectorAll(".o-pivot-cell-value")[4].click(); // should trigger a doAction with appropriate domain
        }
    );
    ...
    QUnit.test("pivot view grouped by date field", async function (assert) {
        ...
        await makeView({
            ...
            mockRPC(route, params) {
                ...
                assert.ok(
                    !wrongFields.length,
                    "fields given to readGroup should exist on the model"
                );
            },
        });
    });
    ...
    QUnit.test("without measures, pivot view uses __count by default", async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left .dropdown-toggle"));
        assert.containsOnce(pivot.el, ".o-cp-bottom-left .dropdown-menu .dropdown-item");
        const measure = pivot.el.querySelector(".o-cp-bottom-left .dropdown-menu .dropdown-item");
    ...
    QUnit.test("pivot view can be reloaded", async function (assert) {
        ...
        assert.containsOnce(
            pivot,
            "td.o-pivot-cell-value:contains(4)",
        ...
        assert.containsOnce(
            pivot,
            "td.o-pivot-cell-value:contains(2)",
    ...
    QUnit.test("pivot view grouped by many2one field", async function (assert) {
        ...
        assert.containsOnce(pivot, ".o-pivot-header-cell-opened", "should have one opened header");
        assert.containsOnce(
            pivot,
            ".o-pivot-header-cell-closed:contains(xphone)",
            "should display one header with 'xphone'"
        );
        assert.containsOnce(
            pivot,
            ".o-pivot-header-cell-closed:contains(xpad)",
    ...
    QUnit.test("basic folding/unfolding", async function (assert) {
        ...
        await click(pivot.el, ".o-pivot-header-cell-opened");

        assert.containsOnce(pivot, "tbody tr", "should have 1 row");

        // click on closed header to open dropdown
        await click(pivot.el, "tbody .o-pivot-header-cell-closed");
        assert.containsOnce(pivot, ".o-pivot .dropdown-menu");
        assert.strictEqual(
            pivot.el.querySelector(".o-pivot .dropdown-menu").innerText.replace(/\s/g, ""),
            "CompanyTypeCustomerDateOtherProductProductbarAddCustomGroup"
        );

        // open the Date sub dropdown
        await mouseEnter(pivot.el, ".o-pivot .dropdown-menu .dropdown-toggle.o-menu-item");
        assert.strictEqual(
            pivot.el
                .querySelector(".o-pivot .dropdown-menu .dropdown-menu")
                .innerText.replace(/\s/g, ""),
            "YearQuarterMonthWeekDay"
        );

        await click(
            pivot.el.querySelectorAll(".o-pivot .dropdown-menu .dropdown-menu .dropdown-item")[2]
        );
    ...
    QUnit.test("more folding/unfolding", async function (assert) {
        ...
        await click(pivot.el.querySelector("tbody .o-pivot-header-cell-closed"));
        ...
        await click(pivot.el.querySelectorAll("tbody th.o-pivot-header-cell-closed")[1]);
    ...
    QUnit.test("fold and unfold header group", async function (assert) {
        ...
        await click(pivot.el.querySelector("thead .o-pivot-header-cell-opened"));
        assert.containsN(pivot, "thead tr", 2);

        // unfold it
        await click(pivot.el.querySelector("thead .o-pivot-header-cell-closed"));
    ...
    QUnit.test("unfold second header group", async function (assert) {
        ...
        // unfold it
        await click(pivot.el.querySelector("thead .o-pivot-header-cell-closed:last-child"));
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.containsN(
                pivot,
                ".o-control-panel .o-cp-bottom-right .dropdown-menu .o-menu-item",
                3,
                "should have 3 dropdown items in searchView groupby"
            );
            assert.containsOnce(
                pivot,
                ".o-control-panel .o-cp-bottom-right .dropdown-menu .o-add-custom_group_menu",
                "should have custom group generator in searchView groupby"
            );

            // click on closed header to open dropdown
            await click(pivot.el, "tbody tr:last-child .o-pivot-header-cell-closed");
            assert.containsN(
                pivot,
            ...
            assert.containsOnce(
                pivot,
                ".dropdown-menu .o-add-custom_group_menu",
                "should have custom group generator same as searchView groupby"
            );
            // check custom groupby selection has groupable fields only
            await mouseEnter(pivot.el, ".dropdown-menu .o-add-custom_group_menu .dropdown-toggle");
            assert.containsN(
                pivot,
                ".dropdown-menu .o-add-custom_group_menu .dropdown-menu option",
                6,
    ...
    QUnit.test("pivot group dropdown sync with search groupby dropdown", async function (assert) {
        ...
        await mouseEnter(pivot.el, ".dropdown-menu .o-add-custom_group_menu .dropdown-toggle");
        pivot.el.querySelector(".dropdown-menu .o-add-custom_group_menu select").value = "date";
        await triggerEvent(pivot.el, ".dropdown-menu .o-add-custom_group_menu select", "change");
        await click(pivot.el, ".dropdown-menu .o-add-custom_group_menu .dropdown-menu .btn");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            // click on closed header to open dropdown
            await click(pivot.el.querySelectorAll("tbody .o-pivot-header-cell-closed")[1]);
            let items = pivot.el.querySelectorAll(".o-menu-item");
            assert.deepEqual(
            ...
            // add a custom group in pivot groupby
            await mouseEnter(pivot.el, ".dropdown-menu .o-add-custom_group_menu .dropdown-toggle");
            pivot.el.querySelector(".o-add-custom_group_menu select").value = "customer";
            await triggerEvent(
                pivot.el,
                ".dropdown-menu .o-add-custom_group_menu select",
                "change"
            );
            await click(pivot.el, ".dropdown-menu .o-add-custom_group_menu .dropdown-menu .btn");

            await click(pivot.el.querySelectorAll("tbody .o-pivot-header-cell-closed")[1]);
            items = pivot.el.querySelectorAll(".o-menu-item");
            assert.deepEqual(
                [...items].map((it) => it.innerText),
        ...
        async function (assert) {
            ...
            await mouseEnter(
                pivot.el.querySelector(
                    "thead .dropdown-menu .o-add-custom_group_menu .dropdown-toggle "
                )
            );

            checkReadGroup = true;
            const select = pivot.el.querySelector(".o-add-custom_group_menu select");
            select.value = "date";
            select.dispatchEvent(new Event("change"));
            await click(pivot.el.querySelector(".o-add-custom_group_menu .btn-primary"));
        }
    );
    ...
    QUnit.test("pivot view without group by specified in search arch", async function (assert) {
        ...
        assert.containsN(
            pivot,
            "tbody .dropdown-menu .o-menu-item",
            6,
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            // Keep productId but make it ungroupable
            delete serverData.models.partner.fields.productId.sortable;
            delete serverData.models.partner.fields.productId.store;
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            // click on closed header to open dropdown
            await click(pivot.el.querySelector("thead .o-pivot-header-cell-closed"));
            assert.containsOnce(pivot, "thead .dropdown-menu .o-add-custom_group_menu");
            await mouseEnter(
                pivot.el.querySelector(
                    "thead .dropdown-menu .o-add-custom_group_menu .dropdown-toggle"
                )
            ...
            assert.containsOnce(
                pivot,
                "thead .dropdown-menu .o-add-custom_group_menu .dropdown-menu"
            );

            // click on apply button should close dropdown
            await click(
                pivot.el.querySelector(
                    "thead .dropdown-menu .o-add-custom_group_menu .dropdown-menu .btn-primary"
                )
            );
    ...
    QUnit.test("can toggle extra measure", async function (assert) {
        ...
        await click($(pivot.el).find(".o-cp-bottom-left .dropdown-item:contains(Count)")[0]);

        assert.hasClass(
            $(pivot.el).find(".o-cp-bottom-left .dropdown-item:contains(Count)"),
            "selected",
    ...
    QUnit.test("no content helper when no data, part 3", async function (assert) {
        ...
        assert.containsOnce(pivot, ".o-searchview .o-searchview-facet");
        assert.containsOnce(pivot, ".o-view-nocontent");

        await toggleFilterMenu(pivot);
        await toggleMenuItem(pivot, "Some Filter");
        assert.containsN(pivot, ".o-searchview .o-searchview-facet", 2);
        assert.containsOnce(pivot, ".o-view-nocontent");
        ...
        await click(pivot.el, ".o-facet-remove");
        assert.containsNone(pivot, ".o-searchview .o-searchview-facet");
        assert.containsNone(pivot, ".o-view-nocontent");
    ...
    QUnit.test("tries to restore previous state after domain change", async function (assert) {
        ...
        assert.containsOnce(
            pivot,
            ".o-pivot-measure-row:contains(Foo)",
    ...
    QUnit.test("can be grouped with the search view", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter string="Product" name="productId" context="{'groupby':'productId'}"/>
                </search>`,
        });

        assert.containsOnce(pivot, ".o-pivot-cell-value", "should have only 1 cell");
        assert.containsOnce(pivot, "tbody tr", "should have 1 rows");

        await toggleGroupByMenu(pivot);
        await toggleMenuItem(pivot, "Product");

        assert.containsN(pivot, ".o-pivot-cell-value", 3, "should have 3 cells");
    ...
    QUnit.test("can sort data in a column by clicking on header", async function (assert) {
        ...
        await click(pivot.el.querySelector("th.o-pivot-measure-row"));
    ...
    QUnit.test("can expand all rows", async function (assert) {
        ...
        await click(pivot.el.querySelectorAll("tbody .o-pivot-header-cell-opened")[3]);
        await click(pivot.el.querySelectorAll("tbody .o-pivot-header-cell-opened")[2]);

        assert.containsN(pivot, "tbody tr", 6, "should have 6 rows now");

        // expand all
        nbReadGroups = 0;
        await click(pivot.el.querySelector(".o-pivot-expand_button"));
    ...
    QUnit.test("can download a file", async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-pivot-download"));
    });
    ...
    QUnit.test("download button is disabled when there is no data", async function (assert) {
        ...
        assert.hasAttrValue(
            pivot.el.querySelector(".o-pivot-download"),
            "disabled",
            "disabled",
    ...
    QUnit.test("correctly save measures and groupbys to favorite", async function (assert) {
        ...
        await click(pivot.el.querySelectorAll("thead .o-pivot-header-cell-closed")[1]);
    ...
    QUnit.test("correctly remove pivot_ keys from the context", async function (assert) {
        ...
        await click(pivot.el, "tbody .o-pivot-header-cell-opened");
        expectedContext = {
            groupby: [],
            pivot_column_groupby: ["customer"],
            pivot_measures: ["foo"],
        ...
        //await click(pivot.el, "tbody .o-pivot-header-cell-opened"); //It was already removed
        await click(pivot.el, "thead .o-pivot-header-cell-opened");
        expectedContext = {
            groupby: [],
        ...
        await click(pivot.el, "thead .o-pivot-header-cell-closed");
    ...
    QUnit.test("Apply two groupby, and remove facet", async function (assert) {
        serverData.views = {
            ...
            "partner,false,search": `
                    <search>
                        <filter name="groupby_product" string="Product" domain="[]" context="{'groupby': 'productId'}"/>
                        <filter name="groupby_bar" string="Bar" domain="[]" context="{'groupby': 'bar'}"/>
                    </search>`,
        };
        ...
        assert.strictEqual(
            webClient.el.querySelector("tbody .o-pivot-header-cell-closed").textContent,
            "First"
        );
    ...
    QUnit.test("Add a group by on the CP when a favorite already exists", async function (assert) {
        serverData.views = {
            ...
            "partner,false,search": `
                    <search>
                        <filter name="groubybar" string="Bar" domain="[]" context="{'groupby': 'bar'}"/>
                    </search>`,
        };
    ...
    QUnit.skip("Removing or adding filter shouldn't modify the row group", async function (assert) {
        ...
        await doAction(webClient, {
            ...
            type: "ir.actions.actwindow",
            views: [[false, "pivot"]],
            context: { search_default_bayou: 1, groupby: ["company_type"] },
        });
        ...
        // Let's get rid of the rows groupBy
        await click(webClient.el, "tbody .o-pivot-header-cell-opened");
        ...
        // Group row by productId
        await click(webClient.el, "tbody .o-pivot-header-cell-closed");
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            serverData.models["partner"].filters = [
                {
                    ...
                    name: "My favorite",
                    id: 5,
                    context: `{"pivot_row_groupby":["productId"], "pivot_column_groupby": ["bar"]}`,
                    sort: "[]",
                    domain: "",
                    is_default: false,
                    modelId: "partner",
            ...
            assert.strictEqual(
                webClient.el.querySelector("thead .o-pivot-header-cell-closed").textContent,
                "December 2016"
            );
            ...
            await click(webClient.el, "tbody .o-pivot-header-cell-opened");
            await click(webClient.el, "thead .o-pivot-header-cell-opened");
    ...
    QUnit.test("Unload Filter, reset display, load another filter", async function (assert) {
        ...
        // Check Columns
        assert.strictEqual(
            $(pivot.el).find("thead .o-pivot-header-cell-opened").length,
            1,
        ...
        // Check Rows
        assert.strictEqual(
            $(pivot.el).find("tbody .o-pivot-header-cell-opened").length,
            1,
        ...
        await click(pivot.el, ".o-pivot-header-cell-opened:first-child");
        await click(pivot.el, ".o-pivot-header-cell-opened");

        // Check Columns
        assert.strictEqual(
            $(pivot.el).find("thead .o-pivot-header-cell-closed").length,
            1,
        ...
        // Check Rows
        assert.strictEqual(
            $(pivot.el).find("tbody .o-pivot-header-cell-closed").length,
            1,
    ...
    QUnit.test("Reload, group by columns, reload", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="my_filter_1" string="My Filter 1" domain="[('productId', '=', 37)]"/>
                    <filter name="my_filter_2" string="My Filter 2" domain="[('productId', '=', 41)]"/>
                </search>`,
            mockRPC(route, args) {
                if (args.method === "create_or_replace") {
                    assert.deepEqual(args.args[0].context, expectedContext);
        ...
        expectedContext = {
            groupby: [],
            pivot_column_groupby: ["customer", "productId"],
            pivot_measures: ["__count"],
            pivot_row_groupby: [],
        };
        await toggleFavoriteMenu(pivot);
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    ...
                    <filter name="my_filter_2" string="My Filter 2" domain="[('productId', '=', 37)]"/>
                </search>`,
            mockRPC(route, args) {
                if (args.method === "create_or_replace") {
                    assert.deepEqual(args.args[0].context, expectedContext);
    ...
    QUnit.test("correctly uses pivot_ keys from the context", async function (assert) {
        ...
        assert.containsOnce(
            pivot,
            "thead .o-pivot-header-cell-opened",
            "column: should have one opened header"
        );
        assert.containsOnce(
            pivot,
            "thead .o-pivot-header-cell-closed:contains(First)",
            "column: should display one closed header with 'First'"
        );
        assert.containsOnce(
            pivot,
            "thead .o-pivot-header-cell-closed:contains(Second)",
            "column: should display one closed header with 'Second'"
        );

        assert.containsOnce(
            pivot,
            "tbody .o-pivot-header-cell-opened",
            "row: should have one opened header"
        );
        assert.containsOnce(
            pivot,
            "tbody .o-pivot-header-cell-closed:contains(xphone)",
            "row: should display one closed header with 'xphone'"
        );
        assert.containsOnce(
            pivot,
            "tbody .o-pivot-header-cell-closed:contains(xpad)",
    ...
    QUnit.test("clear table cells data after closeGroup", async function (assert) {
        ...
        serverData.models.partner.records.find((r) => r.productId === 37).date = "2016-10-27";

        await click(pivot.el.querySelector("tbody .o-pivot-header-cell-opened"));
        await click(pivot.el.querySelector("tbody .o-pivot-header-cell-closed"));
        await click(pivot.el.querySelectorAll("tbody .dropdown-menu .dropdown-item")[4]);
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left .o-pivot-flip_button"));
        await click(pivot.el.querySelector("thead .o-pivot-header-cell-opened"));
        await click(pivot.el.querySelector("thead .o-pivot-header-cell-closed"));
        await click(pivot.el.querySelectorAll("thead .dropdown-menu .dropdown-item")[4]);
    ...
    QUnit.test("correctly group data after flip (1)", async function (assert) {
        ...
        // flip axis
        await click(webClient.el.querySelector(".o-pivot-flip_button"));
        ...
        await click(webClient.el.querySelector("tbody .o-pivot-header-cell-opened"));
    ...
    QUnit.test("correctly uses pivot_ keys from the context (at reload)", async function (assert) {
        ...
        assert.strictEqual(
            pivot.el.querySelector("tbody tr").querySelectorAll("td.o-pivot-cell-value")[4]
                .innerText,
            "0.00",
    ...
    QUnit.test("pivot still handles __count__ measure", async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left button.dropdown-toggle"));
        assert.containsOnce(pivot, ".o-cp-bottom-left .dropdown-item");
        assert.strictEqual(
            pivot.el.querySelector(".o-cp-bottom-left .dropdown-item").innerText,
            "Count"
        );
        assert.hasClass(pivot.el.querySelector(".o-cp-bottom-left .dropdown-item"), "selected");
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.doesNotHaveClass(
                pivot.el.querySelector(".o-cp-bottom-left .dropdown-item"),
                "selected"
            );
        }
    );
    ...
    QUnit.test("m2o as measure, drilling down into data", async function (assert) {
        ...
        assert.strictEqual(
            [...pivot.el.querySelectorAll(".o-pivot-cell-value")].map((c) => c.innerText).join(""),
            "2211",
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await click(pivot.el.querySelector(".o-cp-bottom-left button.dropdown-toggle"));
            await click(pivot.el.querySelector(".o-cp-bottom-left .dropdown-item"));
            assert.strictEqual(
                [...pivot.el.querySelectorAll(".o-pivot-cell-value")]
                    .map((c) => c.innerText)
                    .join(""),
                "421131",
                "should have loaded the proper data"
    ...
    QUnit.test("Row and column groupbys plus a domain", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="some_filter" string="Some Filter" domain="[('productId', '=', 41)]"/>
                </search>`,
            mockRPC(route, args) {
                if (args.method === "create_or_replace") {
                    assert.deepEqual(args.args[0].context, expectedContext);
        ...
        async function (assert) {
            ...
            const pivot = await makeView({
                ...
                searchViewArch: `
                    <search>
                        <filter string="Product" name="productId" context="{'groupby':'productId'}"/>
                        <filter string="Customer" name="customer" context="{'groupby':'customer'}"/>
                    </search>`,
                mockRPC(route, args) {
                    if (args.method === "readGroup") {
                        return Promise.resolve(def);
            ...
            assert.containsOnce(pivot, ".o-pivot-cell-value", "should have 1 cell initially");
            ...
            assert.containsOnce(pivot, ".o-pivot-cell-value", "should still have 1 cell");
            assert.containsOnce(pivot, "tbody tr", "should still have 1 row");

            await def.resolve();
            await nextTick();

            assert.containsN(pivot, ".o-pivot-cell-value", 6, "should have 6 cells");
    ...
    QUnit.test("pivot measures should be alphabetically sorted", async function (assert) {
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left button.dropdown-toggle"));
        assert.strictEqual(
            [...pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-item")]
                .map((i) => i.innerText)
                .join(""),
            "bouhFoomoddZipCount"
        );
    ...
    QUnit.test("pivot view should use default order for auto sorting", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            serverData,
            arch: `
                <pivot defaultOrder="foo asc">
                    <field name="foo" type="measure"/>
                </pivot>`,
        });

        assert.hasClass(
            pivot.el.querySelector("thead th.o-pivot-measure-row"),
    ...
    QUnit.test("pivot view can be flipped", async function (assert) {
        ...
        rpcCount = 0;
        await click(pivot.el.querySelector(".o-pivot-flip_button"));
    ...
    QUnit.test("rendering of pivot view with comparison", async function (assert) {
        ...
        assert.containsOnce(pivot, "p.o-view-nocontent-empty-folder");
        ...
        await click(pivot.el.querySelector(".o-cp-bottom-left button.dropdown-toggle"));
        await click(
            pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-menu .dropdown-item")[0]
        );
        await click(
            pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-menu .dropdown-item")[1]
        );
        values = [
            "1",
            "0",
        ...
        await click(
            pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-menu .dropdown-item")[2]
        );
        await click(
            pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-menu .dropdown-item")[1]
        );
    ...
    QUnit.test("export data in excel with comparison", async function (assert) {
        ...
        assert.containsOnce(pivot, "p.o-view-nocontent-empty-folder", "there should be no data");
        // export data should be impossible since the pivot buttons
        // are deactivated (exception: the 'Measures' button).
        assert.ok(
            pivot.el
                .querySelector(".o-control-panel button.o-pivot-download")
        ...
        await click(pivot.el.querySelector(".o-control-panel button.o-pivot-download"));
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await click(pivot.el.querySelector(".o-pivot-measure-row"));
            values = [
                "17",
                "12",
                "-29.41%",
            ...
            await click(pivot.el.querySelectorAll(".o-pivot-origin-row")[3]);
            values = [
                "17",
                "12",
                "-29.41%",
            ...
            await click(pivot.el.querySelectorAll(".o-pivot-origin-row")[4]);
            values = [
                "17",
                "12",
                "-29.41%",
            ...
            await click(pivot.el.querySelectorAll(".o-pivot-origin-row")[8]);
            values = [
                "17",
                "12",
                "-29.41%",
    ...
    QUnit.test("Click on the measure list but not on a menu item", async function (assert) {
        ...
        assert.containsNone(pivot, ".o-cp-bottom-left .dropdown-menu");

        // open the "Measures" menu
        await click(pivot.el.querySelector(".o-cp-bottom-left .dropdown-toggle"));
        assert.containsOnce(pivot, ".o-cp-bottom-left .dropdown-menu");

        // click on the divider in the "Measures" menu does not crash
        await click(pivot.el.querySelector(".o-cp-bottom-left .dropdown-menu .dropdown-divider"));
        // the menu should still be open
        assert.containsOnce(pivot, ".o-cp-bottom-left .dropdown-menu");

        // click on the measure list but not on a menu item or the separator
        await click(pivot.el.querySelector(".o-cp-bottom-left .dropdown-menu"));
        // the menu should still be open
        assert.containsOnce(pivot, ".o-cp-bottom-left .dropdown-menu");
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await click(webClient.el.querySelectorAll(".o-pivot-cell-value")[1]);
            await legacyExtraNextTick();

            assert.containsOnce(webClient, ".o-list-view");

            await click(
                webClient.el.querySelector(".o-control-panel ol.breadcrumb li.breadcrumb-item")
            );
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            const pivot = await makeView({
                ...
                serverData,
                arch: `
                    <pivot o-enable-linking="1">
                        <field name="date" interval="day" type="row"/>
                    </pivot>`,
            });

            await click(pivot.el.querySelectorAll(".o-value")[1]);
        }
    );
    QUnit.test(
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            // Set a Row groupby
            await click(pivot.el, "tbody tr:nth-child(2) .o-pivot-header-cell-closed");
            await click(pivot.el, "tbody .dropdown-menu .o-menu-item:nth-child(5)");
    ...
    QUnit.test("display only one dropdown menu", async function (assert) {
        ...
        await click(pivot.el.querySelector("thead th.o-pivot-header-cell-closed"));
        await click(pivot.el.querySelectorAll("thead .dropdown-menu .dropdown-item")[5]);

        // Click on the two header dropdown togglers
        await click(pivot.el.querySelectorAll("thead th.o-pivot-header-cell-closed")[0]);
        await click(pivot.el.querySelectorAll("thead th.o-pivot-header-cell-closed")[1]);
    ...
    QUnit.test("empty pivot view with sample data", async function (assert) {
        ...
        assert.containsNone(pivot, ".o-view-nocontent .abc");
        assert.containsOnce(pivot, "table");
        assert.doesNotHaveClass(pivot.el.querySelector("table"), "o-sample-data-disabled");
    });
    ...
    QUnit.test("pivot is reloaded when leaving and coming back", async function (assert) {
        ...
        await click(webClient.el.querySelector(".o-control-panel .o-switch-view.o-pivot"));

        assert.containsOnce(webClient, ".o-pivot-view");
        assert.strictEqual(getCurrentValues(webClient), ["4", "2", "2"].join(","));

        assert.verifySteps(["readGroup", "readGroup"]);
    });
    ...
    QUnit.test("expanded groups are kept when leaving and coming back", async function (assert) {
        ...
        await click(webClient.el.querySelector("tbody .o-pivot-header-cell-closed"));
        await click(webClient.el.querySelector(".o-pivot .dropdown-menu .dropdown-item"));
    ...
    QUnit.test("sorted rows are kept when leaving and coming back", async function (assert) {
        ...
        await click(webClient.el.querySelector("th.o-pivot-measure-row"));
        await click(webClient.el.querySelector("th.o-pivot-measure-row"));
    ...
    QUnit.test("correctly handle concurrent reloads", async function (assert) {
        ...
        let readGroupCount = 0;
        const mockRPC = (route, args) => {
            if (args.method === "readGroup" && def) {
                readGroupCount++;
                if (readGroupCount === 2) {
                    // slow down last readGroup of first reload
                    return Promise.resolve(def);
                }
            }
        };
    ...
    QUnit.test("flip axis while loading a filter", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name="my_filter" string="My Filter" domain="[('productId', '=', 41)]"/>
                </search>`,
            mockRPC(route, args) {
                if (args.method === "readGroup") {
                    return Promise.resolve(def);
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            const pivot = await makeView({
                ...
                searchViewArch: `
                    <search>
                        <filter name="my_filter" string="My Filter" domain="[('productId', '=', 37)]"/>
                    </search>`,
                mockRPC(route, args) {
                    if (args.method === "readGroup") {
                        return Promise.resolve(def);
    ...
    QUnit.test("'Measures' menu when there is no measurable fields", async function (assert) {
        serverData.models.partner = {
            fields: {},
            records: [{ id: 1, displayName: "The one" }],
        };
        const pivot = await makeView({
            type: "pivot",
            resModel: "partner",
        ...
        assert.deepEqual(
            [...pivot.el.querySelectorAll(".o-cp-bottom-left .dropdown-menu .o-menu-item")].map(
                (e) => e.innerText
            ),
            ["Count"]
        );
        // No separator should be displayed in the menu "Measures"
        assert.containsNone(pivot, ".o-cp-bottom-left .dropdown-menu div.dropdown-divider");
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            serverData.models.customer.records = [{ id: 1, displayName: "P" }];
    ...
    QUnit.test("pivot_row_groupby should be also used after first load", async function (assert) {
        ...
        const pivot = await makeView({
            ...
            searchViewArch: `
                <search>
                    <filter name='productId' string="Product" context="{'groupby':'productId'}"/>
                    <filter name='customer' string="Customer" context="{'groupby':'customer'}"/>
                </search>
            `,
            groupBy: ["bar"],
            mockRPC(route, args) {
        ...
        await click(pivot.el.querySelector("tbody th")); // click on row header "Total"
        await click(pivot.el.querySelector("tbody .o-group-by-menu .o-menu-item")); // select "Product"
        ...
        await click(pivot.el.querySelector("tbody th")); // click on row header "Total"
        await click(pivot.el.querySelector("tbody th")); // click on row header "Total"
        await click(pivot.el.querySelectorAll("tbody .o-group-by-menu .o-menu-item")[1]); // select "Customer"
            ...
            const pivot = await makeView({
                ...
                irFilters: [
                    ...
                    },
                    {
                        ...
                        id: 2,
                        context: `{
                            "pivot_column_groupby": ["productId"],
