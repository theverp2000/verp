verp.define('web.Widget', function (require) {
"use strict";
 ...
 *             this.$(".my-button").click(/* an example of event binding * /);
 *
...
var Widget = core.Class.extend(mixins.PropertiesMixin, ServicesMixin, {
     ...
     */
    doToggle: function (display) {
        if (_.isBoolean(display)) {
            display ? this.doShow() : this.doHide();
        } else if (this.$el) {
            this.$el.hasClass('o-hidden') ? this.doShow() : this.doHide();
        }
    },
    /**
