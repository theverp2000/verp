verp.define("web.commonEnv", function (require) {
    "use strict";

    /**
     * This file defines the common environment, which contains everything that
     * is needed in the env for both the backend and the frontend (Verp
     ...
     * on environments.
     *
     * [1] https://github.com/verp/owl/blob/master/doc/reference/environment.md#content-of-an-environment
     */
    ...
    const env = {
        ...
        services: {
            ...
            getCookie() {
                return utils.getCookie(...arguments);
            },
