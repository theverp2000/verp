 ...
 *
 * @typedef { ASTNumber | ASTString | ASTBoolean | ASTNull | ASTList | ASTName | ASTUnaryOperator | ASTBinaryOperator | ASTFunctionCall | ASTAssignment | ASTTuple | ASTDictionary |ASTLookup | ASTIf | ASTBooleanOperator | ASTObjLookup} AST
 */
            ...
            switch (current.value) {
                ...
                case "{": {
                    ...
                    while (tokens[0] && !isSymbol(tokens[0], "}")) {
                        ...
                        if (
                            (key.type !== 1 && key.type !== 5 /* String */ && key.type !== 0) /* Number */ ||
                            !tokens[0] ||
                            !isSymbol(tokens[0], ":")
                        ) {
                            throw new ParserError("parsing error");
