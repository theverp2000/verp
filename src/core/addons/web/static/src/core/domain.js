...
import { evaluate, formatAST, parseExpr } from "./ast/index";
import { toValue } from "./ast/utils";

/**
 * @typedef {import("./js/parser").AST} AST
...
/**
 * Javascript representation of an Verp domain
 */
export class Domain {
    /**
