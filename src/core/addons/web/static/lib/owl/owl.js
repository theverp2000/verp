...
See https://github.com/verp/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in verp ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/verp/owl';
