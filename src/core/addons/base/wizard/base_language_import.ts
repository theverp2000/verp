  ...
  async importLang() {
    ...
    try {
      ...
      if (isInstance(e, ProgrammingError)) {
        ...
        throw new UserError(await this._t(['File %s not imported due to a malformed file.\n\n',
        ...
        throw new UserError(
          await this._t(['File %s not imported due to format mismatch or a malformed file.',
