...
exports.PosModel = Backbone.Model.extend({
    initialize: function(attributes) {
        ...
        this.user = null;
        this.users = [];
        this.employee = {label: null, id: null, barcode: null, userId: null, pin: null};
        this.employees = [];
        this.partners = [];
        this.taxes = [];
    ...
    models: [
    {
      ...
      loaded: function(self, pickingType) {
        ...
        order:  _.map(['sequence','defaultCode','label'], function (label) { return {label: label}; }),
        domain: function(self){
            ...
            _.map(ptavs, function (ptav) {
                if (!self.attributesByPtalId[ptav.attributeLineId[0]]){
                    self.attributesByPtalId[ptav.attributeLineId[0]] = {
                        ...
                        label: tmp.productAttributesById[ptav.attributeId[0]].label,
                ...
                self.attributesByPtalId[ptav.attributeLineId[0]].values.push({
                    ...
                    label: tmp.pavById[ptav.productAttributeValueId[0]].label,
...
exports.Paymentline = Backbone.Model.extend({
    ...
    */
    ...
    exportAsJSON: function(){
        return {
            label: time.datetimeToStr(new Date()),
