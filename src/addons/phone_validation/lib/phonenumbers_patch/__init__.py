...
try:
    ...
    if parse_version('7.6.1') <= parse_version(phonenumbers.__version__) < parse_version('8.12.32'):
        ...
        # loading updated region_CI.js from current directory
        # https://github.com/daviddrysdale/javascript-phonenumbers/blob/v8.12.32/javascript/phonenumbers/data/region_CI.js
