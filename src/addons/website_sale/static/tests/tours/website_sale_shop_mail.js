verp.define('website_sale.tour_shop_mail', function (require) {
'use strict';
...
[
        ...
        tourUtils.goToCart(),
    {
        ...
        run: function () {
            ...
            window.location.href = "/web#action=sale.action_orders&viewType=form&id=" + orderId;
        },
    },
    {
    ...
    },
    {
        ...
        extraTrigger: '.o_statusbar_status .btn-primary:contains("Sales Order")',
    },
    {
        content: "Open recipients dropdown",
        trigger: '.o-field-many2one[name="partner_ids"] .ui-autocomplete-input',
        run: 'click',
    },
    {
    ...
    },
    {
        ...
        extraTrigger: '.o_badge_text:contains("Azure")',
    },
    {
        content: "wait mail to be sent, and go see it",
        trigger: '.o_Message_content:contains("Your"):contains("order")',
        run: function () {
            window.location.href = "/web#action=mail.action_view_mail_mail&viewType=list";
        },
    },
    {
    ...
    },
    {
        ...
        trigger: 'div.oe-form-field-html[name="body_html"] p:contains("Your"):contains("order")',
        extraTrigger: 'div.oe-form-field-html[name="body_html"] a[href^="https://my-test-domain.com"]',
    },
]);
});
