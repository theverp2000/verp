    ...
    tour.register('shop_customize', {
        ...
        [
            ...
            },
            {
                ...
                trigger: "#customizeMenu label:contains(Attributes & Variants filters)",
            },
            {
                content: "select product attribute Steel",
                extraTrigger: 'body:not(:has(#customizeMenu:visible .dropdown-menu:visible))',
            ...
            },
            {
                ...
                trigger: "#customizeMenu label:contains(List View of Variants):has(input:checked)",
            },
            {
            ...
            },
            {
                ...
                trigger: "#customizeMenu label:contains(Attributes & Variants filters):has(input:checked)",
            },
            {
                content: "finish",
                extraTrigger: 'body:not(:has(#products_grid_before .js-attributes))',
