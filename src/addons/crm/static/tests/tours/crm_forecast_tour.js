...
tour.register('crm_forecast', {
    ...
    tour.stepUtils.showAppsMenuItem(),
    {
        ...
        trigger: "input[name=dateDeadline]",
        ...
        trigger: ".o-kanban-record .o_kanban_record_title:contains('Test Opportunity 1')",
        content: "move to the next month",
        run: function (actions) {
            const undefined_groups = $('.o_column_title:contains("Undefined")').length;
            actions.dragAndDrop(` .o-opportunity-kanban .o-kanban-group:eq(${1 + undefined_groups})`, this.$anchor);
        }
    }, {
        trigger: ".o-kanban-record .o_kanban_record_title:contains('Test Opportunity 1')",
        content: "edit lead",
        ...
        trigger: `span[name=dateDeadline]:contains("${moment(today).add(2, 'months').startOf('month').subtract(1, 'days').format("MM/DD/YYYY")}")`,
        ...
        trigger: ".o-kanban-record:contains('Test Opportunity 1'):contains('Won')",
