...
@MetaModel.define()
class AccountCashBookReport extends TransientModel {
    static _module = module;
    static _name = "account.cashbook.report";
    static _description = "Cash Book Report";
    ...
    static accountIds = Fields.Many2many('account.account', {relation: 'accountAccountCashbookReport', column1: 'reportLineId', column2: 'accountId', string: 'Accounts', default: self => self._getDefaultAccountIds()});
    ...
    async checkReport() {
        ...
        return (await this.env.ref('account_daily_reports.actionReportCashBook')).reportAction(this, data);
    }
}