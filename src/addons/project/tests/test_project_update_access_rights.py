...
class TestProjectUpdateAccessRights(TestProjectCommon):
    ...
    def setUpClass(cls):
        ...
        cls.base_user = mail_new_test_user(cls.env, 'Base user', groups='base.groupUser')
        cls.project_user = mail_new_test_user(cls.env, 'Project user', groups='project.group_project_user')
        cls.project_manager = mail_new_test_user(cls.env, 'Project admin', groups='project.groupProjectManager')
        cls.portal_user = mail_new_test_user(cls.env, 'Portal user', groups='base.groupPortal')
