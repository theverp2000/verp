verp.define('project.tour', function(require) {
"use strict";
...
tour.register('projectTour', {
    ...
    trigger: '.o-kanban-button-new',
    extraTrigger: '.o-kanban-group:eq(1)',
    ...
    trigger: ".o-kanban-record:first",
    extraTrigger: '.o-kanban-project-tasks',
    content: _t("Let's start working on your task."),
    position: "bottom",
}, {
    trigger: ".o_ChatterTopbar_buttonSendMessage",
    extraTrigger: '.o-form-project-tasks',
    ...
    extraTrigger: '.o-form-project-tasks.o-form-readonly',
