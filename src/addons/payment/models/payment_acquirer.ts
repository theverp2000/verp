...
class PaymentAcquirer extends Model {
     ...
     * @returns Dict - The action to reload the page
     */
     ...
     * @param companyId The company to which acquirers must belong, as a `res.company` id
     * @param partnerId The partner making the payment, as a `res.partner` id
     * @param opts {
     *      number currencyId: The payment currency if known beforehand, as a `res.currency` id,
     *      boolean forceTokenization: Whether only acquirers allowing tokenization can be matched,
     *      bool isValidation: Whether the operation is a validation,
     *      dict kwargs: Optional data. This parameter is not used here
     * }
     * @returns recordset of `payment.acquirer` - The compatible acquirers
     */
    @api.model()
     ...
     * @param opts {
     *      string provider: The provider of the acquirer handling the transaction,
     *      dict kwargs: The transaction context. This parameter is not used here
     * }
     * @returns boolean - Whether tokenizing the transaction is required
     */
    @api.model()
     ...
     * @param isValidation boolean - isValidation Whether the operation is a validation
     * @returns boolean - Whether the inline form should be instantiated
     */
     ...
     * @param amount float - The amount to pay for the transaction
     * @param currency The currency of the transaction, as a `res.currency` record
     * @param country The customer country, as a `res.country` record
     * @returns float- The computed fees
     */
     ...
     * @returns float - The validation amount
     */
     ...
     * @returns recordset of `res.currency` - The validation currency
     */
     ...
     * @param isValidation boolean - Whether the operation is a validation
     * @returns record of `ir.ui.view` - The redirect form template
     */
