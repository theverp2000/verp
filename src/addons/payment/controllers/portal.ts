...
export class PaymentPortal extends CustomerPortal {
     ...
     * @param txSudo The transaction whose landing routes to update, as a
                                  `payment.transaction` record.
     * @param accessToken The access token used to authenticate the partner
     * @returns null
     */
     ...
     * @param res 
     * @param opts {
     *  string txId: The transaction to confirm, as a `payment.transaction` id
        strinf accessToken: The access token used to verify the user
     * } 
     * @throws theveb.exceptions.NotFound if the access token is invalid
     */
     ...
     * @param req 
     * @param res 
     * @param opts { int tokenId: The token to archive, as a `payment.token` id }
     * @returns null
     */
    ...
    * @param strValue The value to cast as an `int`
    * @returns The casted value, possibly replaced by None if incompatible
     */
    _castAsInt(strValue) {
        try {
    ...
    * @param strValue The value to cast as a `float`
    * @returns The casted value, possibly replaced by None if incompatible
     */
     ...
     * @param partner The partner on behalf on which the payment is made, as a
                                  `res.partner` record.
     * @param documentCompany The company of the document being paid, as a
                                           `res.company` record.
