...
export class CustomerPortal extends http.Controller {
   ...
   * Process a file uploaded from the portal chatter and create the
      ...
      @param {string} resModel name of the model of the original document.
          To check access rights only, it will not be saved here.

      @param {number} resId id of the original document.
          To check access rights only, it will not be saved here.

      @param {string} accessToken accessToken of the original document.
          To check access rights only, it will not be saved here.

      @returns {Dict} attachment data {id, name, mimetype, fileSize, accessToken}
   */
