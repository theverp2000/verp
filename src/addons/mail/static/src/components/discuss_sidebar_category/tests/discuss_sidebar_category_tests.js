...
QUnit.module('discussSidebarCategory', {}, function () {
...
QUnit.test('channel - states: close should update the value on the server', async function (assert) {
    ...
    assert.strictEqual(
        initalSettings.isDiscussSidebarCategoryChannelOpen,
        true,
    ...
    assert.strictEqual(
        newSettings.isDiscussSidebarCategoryChannelOpen,
        false,
...
QUnit.test('channel - states: close from the bus', async function (assert) {
    ...
    await afterNextRender(() => {
        this.env.services.busService.trigger('notification', [{
...
QUnit.test('chat - states: close should call update server data', async function (assert) {
    ...
    assert.strictEqual(
        initalSettings.isDiscussSidebarCategoryChatOpen,
        true,
    ...
    assert.strictEqual(
        newSettings.isDiscussSidebarCategoryChatOpen,
        false,
