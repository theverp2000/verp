...
function factory(dependencies) {
    ...
    class AttachmentImage extends dependencies['mail.model'] {
        ...
        _computeImageUrl() {
            ...
            const accessToken = this.attachment.accessToken ? `?accessToken=${this.attachment.accessToken}` : '';
    ...
    AttachmentImage.fields = {
         ...
         */
        attachmentList: many2one('mail.attachmentList', {
            inverse: 'attachmentImages',
            readonly: true,
            required: true,
        }),
    ...
    AttachmentImage.modelName = 'mail.attachmentImage';

    return AttachmentImage;
}

registerNewModel('mail.attachmentImage', factory);
