...
function factory(dependencies) {
    ...
    class MediaPreview extends dependencies['mail.model'] {
        ...
        disableMicrophone() {
            ...
            this.messaging.models['mail.mediaPreview'].stopTracksOnMediaStream(this.audioStream);
        ...
        disableVideo() {
            ...
            this.messaging.models['mail.mediaPreview'].stopTracksOnMediaStream(this.videoStream);
    ...
    MediaPreview.modelName = 'mail.mediaPreview';

    return MediaPreview;
}

registerNewModel('mail.mediaPreview', factory);
