...
class Channel extends Model {
  ...
  async channelInfo() {
    ...
    const membersByChannel = new DefaultDict(() => this.env.items('mail.channel.partner'));
    const invitedMembersByChannel = new DefaultDict(() => this.env.items('mail.channel.partner'));
    const memberOfCurrentUserByChannel = new DefaultDict(() => this.env.items('mail.channel.partner'));
