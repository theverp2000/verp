...
class Company extends Model {
    ...
    async create(vals) {
        ...
        const sudo = await company.sudo();
        await sudo._createPerCompanyLocations();
        await sudo._createPerCompanySequences();
        await sudo._createPerCompanyPickingTypes();
        await sudo._createPerCompanyRules();
