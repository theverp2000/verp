import { Fields, MetaModel, TransientModel, _Datetime, _super, api } from "../../../core";
        ...
        for (const returnLine of productReturnMoves) {
            ...
            if (quantity) {
                ...
                */
                ...
                // 'returnLine.moveId.move_orig_ids.returned_move_ids.move_orig_ids.moveDestIds'
                // instead of 'returnLine.moveId.move_orig_ids.moveDestIds' prevents linking a
