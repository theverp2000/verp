...
QUnit.module('mrp', {
    ...
    QUnit.test("bullet_state: basic rendering", async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget').text(), "Waiting Materials",
            "the widget should be correctly named");
        assert.containsOnce(form, '.o-field-widget .badge-danger',
    ...
    QUnit.test("mrp_time_counter: basic rendering", async function (assert) {
        ...
        assert.strictEqual(form.$('.o-field-widget[name="duration"]').text(), "150:30",
