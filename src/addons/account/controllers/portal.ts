...
class PortalAccount extends CustomerPortal {
  ...
  async portalMyInvoices(req: WebRequest, res, opts: {page?: any, dateBegin?: any, dateEnd?: any, sortby?: any, filterby?: any}={}) {
    let {page=1, dateBegin, dateEnd, sortby, filterby} = opts;
