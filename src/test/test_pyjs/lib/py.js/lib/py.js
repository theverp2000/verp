...
(function (vj) {
    ...
    vj.VJ_getAttr = function (o, attr_name) {
        return VJ_ensure(o.__getattribute__(attr_name));
    };
    ...
    vj.str = vj.type('str', null, {
        ...
        __hash__: function () {
            return '\x01\0\x01' + this._value; // '\1\0\1'
        },
        __str__: function () {
            return this;
        },
    ...
    var VJ_op = function (o1, o2, op) {
        ...
        if (otherwise) {
            return VJ_ensure(otherwise(o1, o2));
        }
        throw new Error(
    ...
    vj.evaluatePY = function (expr, context) {
        ...
        case '(name)':
            ...
            return VJ_ensure(val, expr.value);
        case '(string)':
    ...
    vj.evaluate = function (expr, context) {
        context = context || {};
        let sandbox = '';
    ...
    vj.eval = function (str, context) {
        ...
        //     context
        // ).toJSON();
        // return JSON.parse(JSON.stringify(vj.evaluate(str, context)));
        return vj.evaluate(str, context);
    }
