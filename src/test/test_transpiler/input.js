/** @verp-module alias=web.public.widget */

verp.define('web.TranslationDialog', function(require) {
    'use strict';
    ...
    var TranslationDialog = Dialog.extend({
        ...
        init: function (parent, options) {
            ...
            this.currentInterfaceLanguage = session.userContext.lang;
        ...
        //--------------------------------------------------------------------------
        /**
         * Load the translation terms for the installed language, for the current model and resId
         * @private
         */
        ...
        _onSave: function () {
            ...
            return Promise.all(saveUpdatedTermsProms).then(() => {
                ...
                if (updateFormViewField) {
                    this.triggerUp('fieldChanged', updateFormViewField);
                }
            });
        }
    });
...
// require('/web/lib/index')
require('web/static/lib/index')

// export function func() {}
export function func() {}
// export async function funcAsync() {}
export async function funcAsync() {}
