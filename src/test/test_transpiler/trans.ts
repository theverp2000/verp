...
function _format(str: string, replacements: Record<string, any>={}): string {
  return str.replace(
    /<\w+>/g,
 ...
 * @param content 
 */
export function getAliasedVerpDefineContent(modulePath: string, content: string) {
  // const matchobj = VERP_MODULE_RE.exec(content);
 ...
 * @param content 
 */
export function convertLegacyDefaultImport(content: string): string {
 ...
 * @returns 
 */
export function convertDefaultImport(content: string): string {
  function repl(matchobj: string, space: string, identifier: string, path, quote, str, quote2) {
    if (quote !== quote2) {
      return matchobj;
    }
 ...
 * @param content 
 */
export function convertBasicImport(content: string) {
 ...
 * @returns 
 */
export function convertStarImport(content) {
 ...
 * @returns 
 */
export function convertUnnamedRelativeImport(content: string): string {
 ...
 * @returns 
 */
export function convertFromExport(content) {
  function repl(matchobj, space, object, path, quote, str, quote2) {
    ...
    return _format("<space>{const <objectClean> = require(<path>); Object.assign(__exports, <objectProcess>)}", {
 ...
 * @returns 
 */
export function convertStarFromExport(content: string): string {  
 ...
 * @returns 
 */
export function convertRelativeRequire(url: string, content: string): string {
 ...
 * @param content 
 */
export function removeIndex(content: string): string {
 ...
 * @returns 
 */
export function convertExportFunction(content: string): string {
 ...
 * @returns 
 */
export function convertExportClass(content: string): string {
 ...
 * @returns 
 */
export function convertVariableExport(content: string): string {
  function repl(matchobj: string, space: string, type: string, identifier: string) {
 ...
 * @returns 
 */
export function convertObjectExport(content: string): string {
 ...
 * @returns 
 */
export function convertExportFunctionDefault(content: string): string {
  function repl(matchobj: string, space: string, type: string, identifier: string) {
 ...
 * @returns 
 */
export function convertExportClassDefault(content: string): string {
  function repl(matchobj: string, space: string, type: string, identifier: string) {
 ...
 * @returns 
 */
export function convertVariableExportDefault(content: string): string {
  function repl(matchobj: string, space: string, type: string, identifier: string) {
 ...
 * @returns 
 */
export function convertDefaultExport(content: string): string {
 ...
 * @param content 
 */
export function wrapWithVerpDefine(modulePath: string, content: string): string {
 ...
 * @returns 
 */
export function relativePathToModulePath(url: string, pathRel: string) {
